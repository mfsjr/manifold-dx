...
export declare function getMappingActionCreator<S extends StateObject, K extends Extract<keyof S, string>, A extends StateObject, E extends unknown>(_parent: S, _propKey: K): {
