...
export declare function getMappingActionCreator<S extends StateObject, K extends Extract<keyof S, string>, A extends StateObject, E extends void>(_parent: S | undefined, _propKey: K): {
    createPropertyMappingAction: <CP, VP, TP extends ExtractMatching<S, K, VP>>(_component: ContainerComponent<CP, VP, A, {}>, targetPropKey: TP, ...postReducerCallbacks: ContainerPostReducer[]) => MappingAction<S, K, CP, VP, TP, A, E>;
};
/**
...
export declare function getArrayMappingActionCreator<S extends StateObject, K extends ExtractArrayKeys<unknown, S>, A extends StateObject>(_parent: S | undefined, _propKey: K): {
    createArrayIndexMappingAction: <CP, VP, E extends unknown, TP extends ExtractMatchingArrayType<E, VP>>(_array: S[K] & E[], index: number | null, _component: ContainerComponent<CP, VP, A, {}>, targetPropKey: TP, ...postReducerCallbacks: ContainerPostReducer[]) => MappingAction<S, K, CP, VP, TP, A, E>;
};
