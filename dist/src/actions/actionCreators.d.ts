...
import { Action, ArrayChangeAction, DispatchType, MappingAction, StateAction, StateCrudAction } from './actions';
...
export declare function getArrayCrudCreator<S extends StateObject, K extends keyof S, V extends Object>(parent: S, childArray: Array<V> & S[K]): ArrayCrudActionCreator<S, K, V>;
/**
