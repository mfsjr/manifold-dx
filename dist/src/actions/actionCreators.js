...
function getArrayCrudCreator(parent, childArray) {
...
var ArrayCrudActionCreator = /** @class */ (function () {
     ...
     */
    function ArrayCrudActionCreator(parent, childArray) {
        this.parent = parent;
        /* tslint:disable:no-any */
...
function getMappingCreator(_parent, _propKey, arrayOptions) {
    ...
    var createArrayIndexMappingAction = function (index, _component, targetPropKey) {
        ...
        var result = mappingAction.setArrayElement(index, arrayOptions.array);
        return result;
    };
    return {
