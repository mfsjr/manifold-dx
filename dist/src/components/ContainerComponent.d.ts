...
export declare abstract class ContainerComponent<CP, VP, A extends StateObject> extends React.Component<CP> {
    ...
    getMappingActions(): MappingAction<any, any, CP, VP, keyof VP>[];
    /**
    ...
    createMapping<S extends StateObject, K extends keyof S>(stateObject: S, stateObjectProperty: K, targetViewProp: keyof VP, ...dispatches: DispatchType[]): MappingAction<S, K, CP, VP, keyof VP>;
    /**
