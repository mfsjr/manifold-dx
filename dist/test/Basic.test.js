...
var AddressFunctionCompSub = function (props) {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement("div", null,
            React.createElement("input", { value: '' + count, onChange: function (e) { return setCount(parseInt(e.target.value, 10)); } }))));
};
/**
...
describe('hook functionality', function () {
    ...
    test('Expect createElement to be renderable using a FunctionComponent with hooks', function () {
        var rendering = enzyme.mount(React.createElement(AddressFunctionCompSub, addr4));
        expect(rendering).toBeTruthy();
    });
    test('Expect an invalid hook call when invoking a FunctionComponent with hooks', function () {
        expect(function () {
            AddressFunctionCompSub(addr4);
        }).toThrow();
    });
    test('Expect no exceptions when createElement uses a FunctionComponent with hooks', function () {
