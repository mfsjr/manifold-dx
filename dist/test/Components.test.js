...
var StateTest = /** @class */ (function (_super) {
    __extends(StateTest, _super);
...
var BowlerContainer = /** @class */ (function (_super) {
    ...
    function BowlerContainer(bowlerProps) {
        var _this = _super.call(this, bowlerProps, testStore.getState(), undefined, StateTest) || this;
        /* tslint:disable:no-any */
        _this.calcAverage = function (action) {
            /* tslint:enable:no-any */
            // console.log(`calcAverage dispatched by ${ActionId[action.type]}`);
            _this.average = _this.viewProps.scores.reduce(function (previous, current) { return previous + current; }, 0.0);
            _this.average = _this.average / _this.viewProps.scores.length;
        };
...
describe('ContainerComponent instantiation, mount, update, unmount', function () {
    ...
    test('an update action', function () {
        ...
        var action = new actions_1.StateCrudAction(actions_1.ActionId.UPDATE_PROPERTY, nameState, 'bowlingScores', bowlingScores);
    ...
    test("Create a mapping action to an array index", function () {
        ...
        var addr1MappingAction = actionCreators_1.getArrayMappingActionCreator(nameState, 'addresses')
        ...
        var addr2MappingAction = actionCreators_1.getArrayMappingActionCreator(nameState, 'addresses')
