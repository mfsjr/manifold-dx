...
describe('ContainerComponent instantiation, mount, update, unmount', function () {
    ...
    test("Create a mapping action to an array index", function () {
        ...
        var addr1MappingAction = actionCreators_1.getMappingActionCreator(nameState, 'addresses', addressesOptions)
        ...
        var addr2MappingAction = actionCreators_1.getMappingActionCreator(nameState, 'addresses', addressesOptions)
