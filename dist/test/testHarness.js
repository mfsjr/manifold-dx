...
function createNameContainer(nameData, parent, myName) {
    ...
    var getAddressesActionCreator = function (_nameState) {
        addressesActionCreator = addressesActionCreator ||
            new actionCreators_1.ArrayCrudActionCreator(_nameState, _nameState.addresses);
        return addressesActionCreator;
    };
    var nameState = __assign({ _parent: parent, _myPropname: myName }, nameData, { getActionCreator: _getActionCreator, getAddressesActionCreator: getAddressesActionCreator });
...
var NameStateCreator = /** @class */ (function () {
    function NameStateCreator(nameData, parent, myName) {
        ...
        this.getAddressesActionCreator = function (nameState) { return src_1.getArrayCrudCreator(_this.nameState, _this.nameState.addresses); };
        this.nameState = __assign({}, nameData, { _parent: parent, _myPropname: myName, getAddressesActionCreator: this.getAddressesActionCreator, getActionCreator: this.getActionCreator });
