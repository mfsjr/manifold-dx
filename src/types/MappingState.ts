...
export class MappingState {
  ...
  private pathMappings = new Map<string, MappingAction<any, any, any, any>[]>();
  ...
  public getSize(): number {
    ...
    /* tslint:disable:no-any */
  public getPathMappings(propFullPath: string): MappingAction<any, any, any, any>[] | undefined {
      /* tslint:enable:no-any */
    return this.pathMappings.get(propFullPath);
  }

    /* tslint:disable:no-any */
  public getOrCreatePathMappings(propFullPath: string): MappingAction<any, any, any, any>[] {
      /* tslint:enable:no-any */
   ...
   */
    /* tslint:disable:no-any */
  public removePathMapping(_fullPath: string, container: MappingAction<any, any, any, any>): number {
    let containers: MappingAction<any, any, any, any>[] | undefined = this.pathMappings.get(_fullPath);
      /* tslint:enable:no-any */
    if (containers) {
