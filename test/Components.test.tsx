...
import {createTestState, ITestState} from "./testHarness";
...
export class BowlerContainer extends ContainerComponent<BowlerProps, ScoreCardProps, ITestState & IStateObject> {

  //nameState = state.getState().name;
  nameState: IName & IStateObject | undefined;
...
let resetTestObjects = () => {
  ...
  nameState = State.createStateObject<IName>(testState.getState(), 'name', name);
